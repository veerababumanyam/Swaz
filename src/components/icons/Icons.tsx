...
export const SwazLogoIcon: React.FC<IconProps> = (props) => (
    <img src="/assets/logo.png" alt="Swaz Data Recovery Labs Logo" {...props} />
);
...
export const PhoneHangUpIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 5.25v2.25m3-3.375-3 3.375M19.5 9.75h2.25M21 12.75v2.25M15 15.75l3.375 3.375M15 19.5h2.25m-2.25 2.25 3.375-3.375M12.75 21v-2.25M9.75 19.5h-2.25M9 15.75l-3.375 3.375M4.5 19.5h-2.25m2.25-2.25L4.5 19.5M3 12.75v-2.25M4.5 9.75h-2.25M9 4.5 5.625 7.875M9 3v2.25M12.75 3v2.25" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 0 1-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 0 0-1.091-.852H4.5A2.25 2.25 0 0 0 2.25 4.5v2.25Z" />
    </svg>
);
